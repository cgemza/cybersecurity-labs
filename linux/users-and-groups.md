...
# View the custom Suricata rule
cat custom.rules

# Check the contents of the Suricata log directory
ls -l /var/log/suricata

# Analyze a packet capture using the custom rule
sudo suricata -r sample.pcap -S custom.rules -k none

# Verify that Suricata generated log files
ls -l /var/log/suricata

# View alerts generated by the custom rule
cat /var/log/suricata/fast.log
Examine Suricata's JSON Event Log

Suricata records detailed event information in the eve.json log. Use cat to view the raw output or jq to format the JSON for easier analysis.

# View the raw event log
cat /var/log/suricata/eve.json

# Easier to read print out the JSON output and browse it with less
